...
from robot_1 import MAX_CAMERA_ANGLE, MIN_CAMERA_ANGLE, CAMERA_TURN_RATE, CAMERA_STABILISATION_TIME, ROBOT_TO_DEFAULT_CAMERA_YAW, CAMERA_MEASUREMENTS
...
CAMERA_PAN_SEQUENCE = [0, 0.2, 0.6, 1, 0.8, 0.4, 0, 0.5, 1, 0.75, 0.25]
