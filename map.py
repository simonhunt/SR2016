...
ROBOT_TO_CAMERA_VECTOR = {'alpha': 0, 'beta': 0, 'gamma': 0.255} #alpha forwards, beta left to right, gamma up
ROBOT_TO_CAMERA_YAW = 0
ROBOT_TO_CAMERA_PITCH = -11 #deg
ROBOT_TO_CAMERA_ROLL = 1.7 #deg

ZONE_0_INITIAL_CAMERA_LOCATION = {'x': 1, 'y': 7, 'z': 0.38, 'yaw': -45, 'pitch': 11, 'roll': 1.7, 'time': None}
