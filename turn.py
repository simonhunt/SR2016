...
def getTeamFacingUp(net, roll, code):
    ...
    if (net == NET_A):
        ...
        print "error marker with undefined net handled in getTeamFacingUp"
...
def getTurns(net, roll, code, zone):
    ...
    if (net == NET_A):
        ...
        print "error marker with undefined net handled in getTurns"
