...
TEST_1 = {'rotate': 150, 'lift': - 40, 'grab': - 50, 'time': 1}
TEST_2 = {'rotate': 150, 'lift': - 40, 'grab': 30, 'time': 5}
TEST_3 = {'rotate': 150, 'lift': 40, 'grab': 30, 'time': 2}
TEST_4 = {'rotate': - 150, 'lift': 40, 'grab': 30, 'time': 3}
TEST_5 = {'rotate': - 150, 'lift': 0, 'grab': 30, 'time': 1}
TEST_6 = {'rotate': - 150, 'lift': 0, 'grab': 0, 'time': 1}

TEST_SEQUENCE = [TEST_1, TEST_2, TEST_3, TEST_4, TEST_5, TEST_6, ARMS_UP_OUT_THE_WAY]
